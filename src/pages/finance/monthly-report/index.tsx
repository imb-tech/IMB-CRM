...
import { useMonthlyReportCols } from "./columns"
import { useNavigate } from "@tanstack/react-router"

function FinanceMonthlyReporMain() {
    const navigate = useNavigate()
    const columns = useMonthlyReportCols()
    return (
        <Card>
                    ...
                    head={
                        <div className="flex mb-3  justify-between items-center gap-3 ">
                            <div className="flex items-center gap-3">
                                <h1 className="text-xl">{`Oylik Hisobotlar ro'yxati`}</h1>
...
export default FinanceMonthlyReporMain
