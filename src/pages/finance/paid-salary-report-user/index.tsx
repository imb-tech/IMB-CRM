...
import { usePaidSalaryReportUserCols } from "./columns"
import { useNavigate } from "@tanstack/react-router"
import { ArrowLeft } from "lucide-react"
import { Button } from "@/components/ui/button"

function FinancePaidSalaryReportMainUser() {
    const navigate = useNavigate()
    const columns = usePaidSalaryReportUserCols()
    return (
        <Card>
                        ...
                        <div className="flex mb-3  justify-between items-center gap-3 ">
                            <div className="flex items-center gap-3">
                                <Button
                                    onClick={() =>
                                        navigate({
                                            to: "/finance/monthly/paid-salary-report/$id",
                                            params: { id: "2" },
                                        })
                                    }
                                    size={"sm"}
                                ...
                                />
                                <h1 className="text-xl">{`To'langan Oyliklar  ro'yxati`}</h1>
...
export default FinancePaidSalaryReportMainUser
