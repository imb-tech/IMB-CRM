...
import { usePaidSalaryReportCols } from "./columns"
import { useNavigate } from "@tanstack/react-router"
import { ArrowLeft } from "lucide-react"
import { Button } from "@/components/ui/button"

function FinancePaidSalaryReportMain() {
    const navigate = useNavigate()
    const columns = usePaidSalaryReportCols()
    return (
        <Card>
            <CardContent className="space-y-4">
                <DataTable
                    ...
                    onRowClick={() =>
                        navigate({
                            to: "/finance/monthly/paid-salary-report-user/$id",
                            params: { id: "2" },
                        })
                    }
                    head={
...
export default FinancePaidSalaryReportMain
